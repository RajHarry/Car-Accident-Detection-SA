...
def get_score(video_path, weights_path = weight_default_path, no_segment = no_segment):
    ...
    # print("video_path-3: ",video_path)
    # print("feature_alias:{}".format(feature_alias))
    FeaturePath=(video_path)
    # print("Feature_path-0: ",FeaturePath)
    FeaturePath = FeaturePath[0:-4]
    # print("Feature_path-1: ",FeaturePath)
    FeaturePath = FeaturePath.replace('videos/normal', 'features')
    # print("Feature_path-2: ",FeaturePath)
    FeaturePath = FeaturePath.replace('videos/abnormal', 'features')
    # print("Feature_path-3: ",FeaturePath)
    FeaturePath = FeaturePath+ feature_alias
    # print("Feature_path-4: ",FeaturePath)
    ...
    # print("scores: {}\nscores1:{}".format(scores,scores1))
    # print("comparision: ",scores[0],scores1[0])
    return x, scores1
